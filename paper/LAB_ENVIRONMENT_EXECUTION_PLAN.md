...
P0 成功结果可能补入第 3 节 Evaluation Protocol 与第 4 节 Results and Discussion；P1 只在第 2 节或补充材料报告流程覆盖；P2 是第 5 节“缺少 relevance / citation-support 人工审查”的直接补充。在这些任务完成并审核前，`v2/main.tex` 的当前结论保持不变。
